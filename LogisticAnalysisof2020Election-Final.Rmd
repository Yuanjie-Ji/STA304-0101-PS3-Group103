...
We calculated that the proportion of people voting for Trump is 42.38%, and the proportion of people voting for Biden is 43.97% based on both random intercept logistic regression models in favor of Donald Trump and Joe Biden with post-stratification techniques. These two models accounted for predictor variables of gender, race, age group, education level, and region. 
